...
#variavel para dividir o lvl por 500
length = 500 / level

root = Tk()
#titulo usando módulo title
...
# Variável
count = 0
#variavel lost começa com False
lost = False
...
# função para contagem dos pontos
def score():
